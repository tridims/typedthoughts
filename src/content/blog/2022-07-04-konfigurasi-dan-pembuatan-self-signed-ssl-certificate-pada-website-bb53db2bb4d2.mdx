...
heroImage:
    image: "../../assets/ssl-website/0IttxPpNmv4n2kqKk.jpg"
    source: "https://unsplash.com/@markusspiske?utm_source=medium&utm_medium=referral"
    owner: "Markus Spiske"
externalPost: "https://tridims.medium.com/konfigurasi-dan-pembuatan-self-signed-ssl-certificate-pada-website-ssl-website"
shorts: |
    ...
    > ```
    > 2. Tambahkan parameter keamanan (contoh: /etc/apache2/conf-available/ssl-params.conf)
    > - Batasi protokol dan cipher, set header keamanan, matikan kompresi SSL, aktifkan stapling.
    > 3. Update VirtualHost SSL (/etc/apache2/sites-available/default-ssl.conf)
...
Ketika dibuka, akan ada tampilan bahwa koneksi tidak private dengan kode error NET::ERR_CERT_AUTHORITY_INVALID\. Kemudian ketika dipaksa untuk tampil maka google chrome akan melabeli site tersebut dengan tidak secure\.
