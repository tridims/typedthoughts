...
heroImage:
    image: ../../assets/d23309750e10/06QYOVknjvvwFBtZd.png
externalPost: https://tridims.medium.com/mengenal-serangan-cross-site-scripting-xss-pada-website-d23309750e10
description: "XSS adalah serangan injeksi skrip pada sisi klien yang memungkinkan penyerang menjalankan kode berbahaya di browser korban untuk mencuri data, mengambil alih sesi, atau menyebarkan malware."
shorts: |
    ...
    **Dampak**
    XSS dapat menyebabkan pencurian cookie/kredensial, sesi dibajak, distribusi phishing/malware, dan manipulasi konten. Stored XSS biasanya berdampak paling parah.
