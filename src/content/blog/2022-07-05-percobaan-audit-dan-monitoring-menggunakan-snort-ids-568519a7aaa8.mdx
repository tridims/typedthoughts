...
shorts: |
    ...
    - Tes konfigurasi: sudo snort -T -i <iface> -c /usr/local/etc/snort/snort.lua
    - Jalankan Snort untuk logging: sudo snort -l ./log -L pcap -A fast -q -c … -i <iface>
